...
class Simulation:
    def __init__(self, initial_pollution, initial_temperature, initial_sea_mass, initial_cities_ratio, initial_forests_ratio, grid_size=(10, 10, 10), days=5):
        """
        ...
        self.initial_sea_mass = initial_sea_mass
    ...
    def _update_aggregates(self, state):
        ...
        self.water_mass_over_time.append(state.avg_sea_mass)
        ...
        logging.debug(
            ...
            f"Water Mass: {state.avg_sea_mass}, Cities: {state.total_cities}, Forests: {state.total_forests}"
        )
    ...
    def run(self):
        ...
        initial_state = State(
            ...
            initial_sea_mass=self.initial_sea_mass,
