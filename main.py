...
initial_pollution = float(input("Initial pollution level (e.g., 10.0) (default: 30.0): ") or 10)
initial_temperature = float(input("Initial temperature (e.g., 15.0) (default: 25.0): ") or 15.0)
initial_water_mass = float(input("Initial water level (e.g., 1.0) (default: 1.0): ") or 5.0)
