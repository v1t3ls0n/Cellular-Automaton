...
initial_cities = int(input("Initial number of cities (e.g., 50) (default: 50): ") or 300)
initial_forests = int(input("Initial number of forests (e.g., 50) (default: 50): ") or 700)
grid_size = (10,10,10)
