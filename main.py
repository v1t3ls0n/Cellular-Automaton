...
initial_cities = int(input("Initial number of cities (e.g., 50) (default: 50): ") or 400)
initial_forests = int(input("Initial number of forests (e.g., 50) (default: 50): ") or 400)
grid_size = (10,10,10)
